...
Task 4: try, setting a value to name, by directly accessing it using obj and also try printing it Error: you might seen some error, 
please not it down in commnets
...
Encapsulation is used for hidding data, you can create a readOnly member, by just implementing getter funtion for that Or you can 
also create a writeOnly member, by just implementing setter function for that
...
public class Main {
    public static void main(String args[]) {
        ...
        System.out.prinln(name.getName());
    }
}